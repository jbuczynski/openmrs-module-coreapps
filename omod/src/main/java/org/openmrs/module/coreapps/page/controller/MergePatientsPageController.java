...
public class MergePatientsPageController {
    ...
    public String post(UiUtils ui,
        ...
        if (preferredWrapper.isUnknownPatient() && !notPreferredWrapper.isUnknownPatient()){
			request.getSession().setAttribute("emr.errorMessage", ui.message("emr.mergePatients.unknownPatient.error"));
        ...
        request.getSession().setAttribute(AppUiConstants.SESSION_ATTRIBUTE_INFO_MESSAGE, "emr.mergePatients.success");
